...
public class EmployerViewContract extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_employer_view_contract);
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.employer_view_contract_layout), (v, insets) -> {
    ...
    private void fetchContracts() {
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                runOnUiThread(() -> {
                    Toast.makeText(EmployerViewContract.this, "Failed to fetch contracts", Toast.LENGTH_SHORT).show();
                });
            }
                                ...
                                for (Map.Entry<Integer, List<LatLng>> entry : polygonPointsMap.entrySet()) {
                                    ...
                                    if (points.size() > 2) { // A polygon needs at least 3 points
                                        mMap.addPolygon(new PolygonOptions()
                                                .addAll(points)
                                                .strokeColor(Color.RED) // Polygon border color
