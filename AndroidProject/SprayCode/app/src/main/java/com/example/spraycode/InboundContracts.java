...
public class InboundContracts extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_inbound_contracts);
...
//        contractsRecyclerView.setAdapter(new ContractsAdapter(contracts));
    ...
    private void fetchContracts(RecyclerView recyclerView) {
        ...
        Request request = new Request.Builder()
                .url(getString(R.string.url_base) + "/api/inbound_contracts_info")
                .post(formBody)
                .build();
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                runOnUiThread(() -> {
                    Toast.makeText(InboundContracts.this, "Failed to fetch contracts", Toast.LENGTH_SHORT).show();
                });
            }
                    ...
                    try (ResponseBody responseBody = response.body()) {
                        if (responseBody != null) {
                            ...
                            for (List<Object> item : data) {
                                ...
                                String issuerEmail = (String) item.get(1);
...
//                                String endTime = (String) item.get(10);
                                ...
                                contracts.add(new Contract("Contract_"+id, issuerEmail, amount+"("+interval+")", endDate, status, "contractor"));
